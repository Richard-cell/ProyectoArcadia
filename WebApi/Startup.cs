...
namespace WebApi
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ColegioContext>(opt => opt.UseSqlServer("Server = (localdb)\\MSSQLLocalDB; Database = ColegioDB; Trusted_Connection = True; MultipleActiveResultSets = true"));
